...
################################################################################
## Form generated from reading UI file 'servicoLrhtzD.ui'
##
...
class Ui_Janela_Servico(object):
    def setupUi(self, Janela_Servico):
        if not Janela_Servico.objectName():
            Janela_Servico.setObjectName(u"Janela_Servico")
        Janela_Servico.setWindowModality(Qt.ApplicationModal)
        Janela_Servico.resize(550, 450)
        Janela_Servico.setMinimumSize(QSize(550, 450))
        Janela_Servico.setMaximumSize(QSize(550, 450))
        self.centralwidget = QWidget(Janela_Servico)
...
"}")
        ...
        Janela_Servico.setCentralWidget(self.centralwidget)

        self.retranslateUi(Janela_Servico)

        QMetaObject.connectSlotsByName(Janela_Servico)
    # setupUi

    def retranslateUi(self, Janela_Servico):
        Janela_Servico.setWindowTitle(QCoreApplication.translate("Janela_Servico", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Servico", u"Cadastro de Servi\u00e7os", None))
        self.nome_label.setText(QCoreApplication.translate("Janela_Servico", u"Nome *", None))
        self.valor_label.setText(QCoreApplication.translate("Janela_Servico", u"Valor *", None))
        self.descricao_label.setText(QCoreApplication.translate("Janela_Servico", u"Descri\u00e7\u00e3o", None))
        self.label.setText(QCoreApplication.translate("Janela_Servico", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Servico", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Servico", u"CANCELAR", None))
    # retranslateUi
