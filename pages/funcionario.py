...
################################################################################
## Form generated from reading UI file 'funcionarioQvVIxb.ui'
##
...
class Ui_Janela_Funcionario(object):
    def setupUi(self, Janela_Funcionario):
        if not Janela_Funcionario.objectName():
            Janela_Funcionario.setObjectName(u"Janela_Funcionario")
        Janela_Funcionario.setWindowModality(Qt.ApplicationModal)
        Janela_Funcionario.resize(650, 500)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Janela_Funcionario.sizePolicy().hasHeightForWidth())
        Janela_Funcionario.setSizePolicy(sizePolicy)
        Janela_Funcionario.setMinimumSize(QSize(650, 500))
        Janela_Funcionario.setMaximumSize(QSize(650, 500))
        self.centralwidget = QWidget(Janela_Funcionario)
...
"}")
        ...
        Janela_Funcionario.setCentralWidget(self.centralwidget)
        ...
        self.retranslateUi(Janela_Funcionario)

        QMetaObject.connectSlotsByName(Janela_Funcionario)
    # setupUi

    def retranslateUi(self, Janela_Funcionario):
        Janela_Funcionario.setWindowTitle(QCoreApplication.translate("Janela_Funcionario", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Funcionario", u"Cadastro de Funcion\u00e1rios", None))
        self.cpf_label.setText(QCoreApplication.translate("Janela_Funcionario", u"CPF *", None))
        self.bairro_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Bairro", None))
        self.numero_label.setText(QCoreApplication.translate("Janela_Funcionario", u"N\u00famero", None))
        self.email_label.setText(QCoreApplication.translate("Janela_Funcionario", u"E-mail", None))
        self.cpf.setInputMask(QCoreApplication.translate("Janela_Funcionario", u"999.999.999-99", None))
        self.celular_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Celular *", None))
        self.cidade_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Cidade", None))
        self.celular.setInputMask(QCoreApplication.translate("Janela_Funcionario", u"(99) 99999-9999", None))
        self.celular.setText(QCoreApplication.translate("Janela_Funcionario", u"() -", None))
        self.logradouro_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Logradouro", None))
        self.nome_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Nome *", None))
        self.logradouro.setText("")
#if QT_CONFIG(tooltip)
        self.bairro.setToolTip(QCoreApplication.translate("Janela_Funcionario", u"<html><head/><body><p>N\u00famero da casa</p><p><br/></p></body></html>", None))
        ...
        self.dataNasc_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Data de nascimento", None))
        self.sexo_label.setText(QCoreApplication.translate("Janela_Funcionario", u"Sexo", None))
        self.sexo.setItemText(0, QCoreApplication.translate("Janela_Funcionario", u"Masculino", None))
        self.sexo.setItemText(1, QCoreApplication.translate("Janela_Funcionario", u"Feminino", None))

        self.label.setText(QCoreApplication.translate("Janela_Funcionario", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Funcionario", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Funcionario", u"CANCELAR", None))
    # retranslateUi
