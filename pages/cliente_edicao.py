...
################################################################################
## Form generated from reading UI file 'cliente _edicaoVsftRO.ui'
##
...
class Ui_Janela_Cliente_Edicao(object):
    def setupUi(self, Janela_Cliente_Edicao):
        if not Janela_Cliente_Edicao.objectName():
            Janela_Cliente_Edicao.setObjectName(u"Janela_Cliente_Edicao")
        Janela_Cliente_Edicao.setWindowModality(Qt.ApplicationModal)
        Janela_Cliente_Edicao.resize(650, 500)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Janela_Cliente_Edicao.sizePolicy().hasHeightForWidth())
        Janela_Cliente_Edicao.setSizePolicy(sizePolicy)
        Janela_Cliente_Edicao.setMinimumSize(QSize(650, 500))
        Janela_Cliente_Edicao.setMaximumSize(QSize(650, 500))
        self.centralwidget = QWidget(Janela_Cliente_Edicao)
...
"}")
        ...
        Janela_Cliente_Edicao.setCentralWidget(self.centralwidget)
        ...
        self.retranslateUi(Janela_Cliente_Edicao)

        QMetaObject.connectSlotsByName(Janela_Cliente_Edicao)
    # setupUi

    def retranslateUi(self, Janela_Cliente_Edicao):
        Janela_Cliente_Edicao.setWindowTitle(QCoreApplication.translate("Janela_Cliente_Edicao", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Edi\u00e7\u00e3o de Clientes", None))
        self.cpf_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"CPF *", None))
        self.bairro_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Bairro", None))
        self.numero_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"N\u00famero", None))
        self.email_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"E-mail", None))
        self.cpf.setInputMask(QCoreApplication.translate("Janela_Cliente_Edicao", u"999.999.999-99", None))
        self.celular_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Celular *", None))
        self.cidade_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Cidade", None))
        self.celular.setInputMask(QCoreApplication.translate("Janela_Cliente_Edicao", u"(99) 99999-9999", None))
        self.celular.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"() -", None))
        self.logradouro_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Logradouro", None))
        self.nome_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Nome *", None))
        self.logradouro.setText("")
#if QT_CONFIG(tooltip)
        self.bairro.setToolTip(QCoreApplication.translate("Janela_Cliente_Edicao", u"<html><head/><body><p>N\u00famero da casa</p><p><br/></p></body></html>", None))
        ...
        self.dataNasc_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Data de nascimento", None))
        self.sexo_label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"Sexo", None))
        self.sexo.setItemText(0, QCoreApplication.translate("Janela_Cliente_Edicao", u"Masculino", None))
        self.sexo.setItemText(1, QCoreApplication.translate("Janela_Cliente_Edicao", u"Feminino", None))

        self.label.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Cliente_Edicao", u"CANCELAR", None))
    # retranslateUi
