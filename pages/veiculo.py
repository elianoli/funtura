...
################################################################################
## Form generated from reading UI file 'veiculoXnCYwQ.ui'
##
...
class Ui_Janela_Veiculo(object):
    def setupUi(self, Janela_Veiculo):
        if not Janela_Veiculo.objectName():
            Janela_Veiculo.setObjectName(u"Janela_Veiculo")
        Janela_Veiculo.setWindowModality(Qt.ApplicationModal)
        Janela_Veiculo.resize(550, 450)
        Janela_Veiculo.setMinimumSize(QSize(550, 450))
        Janela_Veiculo.setMaximumSize(QSize(550, 450))
        self.centralwidget = QWidget(Janela_Veiculo)
...
"}font: 9pt \"MS Shell Dlg 2\";")
        ...
        Janela_Veiculo.setCentralWidget(self.centralwidget)
        QWidget.setTabOrder(self.botao_salvar, self.botao_cancelar)

        self.retranslateUi(Janela_Veiculo)

        QMetaObject.connectSlotsByName(Janela_Veiculo)
    # setupUi

    def retranslateUi(self, Janela_Veiculo):
        Janela_Veiculo.setWindowTitle(QCoreApplication.translate("Janela_Veiculo", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Veiculo", u"Cadastro de Ve\u00edculos", None))
        self.label_4.setText(QCoreApplication.translate("Janela_Veiculo", u"Placa *", None))
        self.label_2.setText(QCoreApplication.translate("Janela_Veiculo", u"Marca *", None))
        self.label_3.setText(QCoreApplication.translate("Janela_Veiculo", u"Cor", None))
        self.label_5.setText(QCoreApplication.translate("Janela_Veiculo", u"Ano Fab.*", None))
        self.ano_fab.setInputMask(QCoreApplication.translate("Janela_Veiculo", u"9999", None))
        self.label_6.setText(QCoreApplication.translate("Janela_Veiculo", u"Descri\u00e7\u00e3o", None))
        self.label.setText(QCoreApplication.translate("Janela_Veiculo", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Veiculo", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Veiculo", u"CANCELAR", None))
    # retranslateUi
