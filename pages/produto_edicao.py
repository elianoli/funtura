...
################################################################################
## Form generated from reading UI file 'produto_edicaoGkMWUy.ui'
##
...
class Ui_Janela_Produto_Edicao(object):
    def setupUi(self, Janela_Produto_Edicao):
        if not Janela_Produto_Edicao.objectName():
            Janela_Produto_Edicao.setObjectName(u"Janela_Produto_Edicao")
        Janela_Produto_Edicao.setWindowModality(Qt.ApplicationModal)
        Janela_Produto_Edicao.resize(550, 450)
        Janela_Produto_Edicao.setMinimumSize(QSize(550, 450))
        Janela_Produto_Edicao.setMaximumSize(QSize(550, 450))
        self.centralwidget = QWidget(Janela_Produto_Edicao)
...
"}")
        ...
        Janela_Produto_Edicao.setCentralWidget(self.centralwidget)

        self.retranslateUi(Janela_Produto_Edicao)

        QMetaObject.connectSlotsByName(Janela_Produto_Edicao)
    # setupUi

    def retranslateUi(self, Janela_Produto_Edicao):
        Janela_Produto_Edicao.setWindowTitle(QCoreApplication.translate("Janela_Produto_Edicao", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"Edi\u00e7\u00e3o de Produtos", None))
        self.nome_label.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"Nome *", None))
        self.valor_label.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"Valor *", None))
        self.descricao_label.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"Descri\u00e7\u00e3o", None))
        self.label.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Produto_Edicao", u"CANCELAR", None))
    # retranslateUi
