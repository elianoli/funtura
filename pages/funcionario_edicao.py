...
################################################################################
## Form generated from reading UI file 'funcionario_edicaoYcIvdy.ui'
##
...
class Ui_Janela_Funcionario_Edicao(object):
    def setupUi(self, Janela_Funcionario_Edicao):
        if not Janela_Funcionario_Edicao.objectName():
            Janela_Funcionario_Edicao.setObjectName(u"Janela_Funcionario_Edicao")
        Janela_Funcionario_Edicao.setWindowModality(Qt.ApplicationModal)
        Janela_Funcionario_Edicao.resize(650, 500)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Janela_Funcionario_Edicao.sizePolicy().hasHeightForWidth())
        Janela_Funcionario_Edicao.setSizePolicy(sizePolicy)
        Janela_Funcionario_Edicao.setMinimumSize(QSize(650, 500))
        Janela_Funcionario_Edicao.setMaximumSize(QSize(650, 500))
        self.centralwidget = QWidget(Janela_Funcionario_Edicao)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.botao_cancelar.sizePolicy().hasHeightForWidth())
        self.botao_cancelar.setSizePolicy(sizePolicy2)
...
"}")
        ...
        Janela_Funcionario_Edicao.setCentralWidget(self.centralwidget)
        ...
        self.retranslateUi(Janela_Funcionario_Edicao)

        QMetaObject.connectSlotsByName(Janela_Funcionario_Edicao)
    # setupUi

    def retranslateUi(self, Janela_Funcionario_Edicao):
        Janela_Funcionario_Edicao.setWindowTitle(QCoreApplication.translate("Janela_Funcionario_Edicao", u"MainWindow", None))
        self.label_titulo.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Edi\u00e7\u00e3o de Funcion\u00e1rios", None))
        self.cpf_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"CPF *", None))
        self.bairro_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Bairro", None))
        self.numero_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"N\u00famero", None))
        self.email_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"E-mail", None))
        self.cpf.setInputMask(QCoreApplication.translate("Janela_Funcionario_Edicao", u"999.999.999-99", None))
        self.celular_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Celular *", None))
        self.cidade_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Cidade", None))
        self.celular.setInputMask(QCoreApplication.translate("Janela_Funcionario_Edicao", u"(99) 99999-9999", None))
        self.celular.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"() -", None))
        self.logradouro_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Logradouro", None))
        self.nome_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Nome *", None))
        self.logradouro.setText("")
#if QT_CONFIG(tooltip)
        self.bairro.setToolTip(QCoreApplication.translate("Janela_Funcionario_Edicao", u"<html><head/><body><p>N\u00famero da casa</p><p><br/></p></body></html>", None))
        ...
        self.dataNasc_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Data de nascimento", None))
        self.sexo_label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"Sexo", None))
        self.sexo.setItemText(0, QCoreApplication.translate("Janela_Funcionario_Edicao", u"Masculino", None))
        self.sexo.setItemText(1, QCoreApplication.translate("Janela_Funcionario_Edicao", u"Feminino", None))

        self.label.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"* Campos Obrigat\u00f3rios", None))
        self.botao_salvar.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"SALVAR", None))
        self.botao_cancelar.setText(QCoreApplication.translate("Janela_Funcionario_Edicao", u"CANCELAR", None))
    # retranslateUi
