...
################################################################################
## Form generated from reading UI file 'receber_parcela.ui'
##
...
"}")
        ...
        self.tab_rec_par.setFocusPolicy(Qt.ClickFocus)
        self.tab_rec_par.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tab_rec_par.setSelectionMode(QAbstractItemView.SingleSelection)
        self.tab_rec_par.setSelectionBehavior(QAbstractItemView.SelectRows)
